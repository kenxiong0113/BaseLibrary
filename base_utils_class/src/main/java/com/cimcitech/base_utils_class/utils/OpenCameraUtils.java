...
public class OpenCameraUtils {
    ...
    private static final String OUTPUTPATH = "/Pictures/carmanage/images/";
    private static final String COMPRESSPATH = "/Pictures/carmanage/images/zip/";
    ...
    public Uri getUri(String path) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authorities = "com.cimcitech.carmanage.pictureSelectorProvider";
